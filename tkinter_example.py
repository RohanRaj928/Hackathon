...
def load_csv_data():
    csv_data = {}
    with open('DIAGEO_SCOTLAND_FULL_YEAR_2024_DAILY_DATA (1).CSV', mode='r') as file:
...
style.configure('TLabel', background='#e0f7e0', foreground='#004d00', font=('Arial', 14))
style.configure('TButton', background='#004d00', foreground='#ffffff', font=('Arial', 14))
style.configure('TRadiobutton', background='#e0f7e0', foreground='#004d00', font=('Arial', 14))
style.configure('TCombobox', background='#e0f7e0', foreground='#004d00', font=('Arial', 14))
